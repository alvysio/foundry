...
export const alvysIntelligence = createPiece({
  ...
  description:
    'Alvys-managed AI capabilities — document extraction, structured data, and AI-powered automations routed through the Alvys broker (safety, PII redaction, audit logging, usage metering).',
  auth: PieceAuth.None(),
  ...
  actions: [extractDocument, buildExtractPipeline],
  triggers: [],
});
