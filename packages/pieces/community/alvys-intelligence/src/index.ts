...
export const alvysIntelligence = createPiece({
  ...
  description:
    'Alvys-branded AI capabilities — tier-routed chat, document extraction, PII redaction, prompt-injection scanning, rate limiting, and circuit-breaker resilience. All processing runs inside the Activepieces sandbox; no external Alvys service in the request path.',
  ...
  actions: [askAlvysAi, classifyDocument, routeDocument, extractDocument],
  triggers: [],
});
