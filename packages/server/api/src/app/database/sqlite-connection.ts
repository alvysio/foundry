...
import { AddOdinTierConfigTableSqlite1794000000000 } from './migration/sqlite/1794000000000-AddOdinTierConfigTableSqlite'
...
const getMigrations = (): (new () => MigrationInterface)[] => {
    const communityMigrations = [
        ...
        AddOdinTierConfigTableSqlite1794000000000,
    ]
